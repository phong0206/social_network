  ...
  const handleLogout = () => {
    persistor
      ...
      .then(() => {
        ...
        toast.toastSuccess('Logout successful!');
        setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <HStack spacing={{ base: '0', md: '6' }}>
        {windowWidth > 950 && <Input placeholder={t('search')} width="300px" />}
        <ColorModeToggle />
        <Menu>
          <MenuButton marginLeft={windowWidth < 768 ? 2 : -2} as={Button}>
            {t('language')}
          </MenuButton>
          <MenuList>
        ...
        <Flex alignItems={'center'}>
          <Menu>
            <MenuButton py={2} transition="all 0.3s" _focus={{ boxShadow: 'none' }}>
              <HStack>
                ...
                <VStack display={{ base: 'none', md: 'flex' }} alignItems="flex-start" spacing="1px" ml="2">
                  <Text fontSize="sm" width="full" whiteSpace="nowrap" overflow="hidden" textOverflow="ellipsis">
                    Justina Clark
                  </Text>
            ...
            >
              ...
              <MenuItem as={Link} to="/detail-user">
                {t('settings')}
              </MenuItem>
              <MenuDivider />
